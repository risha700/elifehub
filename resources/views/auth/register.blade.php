                    ...
                    <form class="uk-form-stacked" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div>
                            ...
                            <div class="uk-inline uk-width-1-1">
                                ...
                                <input id="name" type="text" class="uk-border-pill uk-input{{ $errors->has('name') ? ' uk-form-danger' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
                            </div>
                        ...
                        <div class="uk-margin">
                            ...
                            <div class="uk-inline uk-width-1-1">
                                ...
                                <input id="email" type="email" class="uk-border-pill uk-input{{ $errors->has('email') ? ' uk-form-danger' : '' }}" name="email" value="{{ old('email') }}" required>
                        ...
                        <div class="uk-margin">
                            ...
                            <div class="uk-inline uk-width-1-1">
                                <input id="password_confirmation" type="password" class="uk-border-pill uk-input{{ $errors->has('password_confirmation') ? ' uk-form-danger' : '' }}" name="password_confirmation" value="{{ old('password_confirmation') }}" required>
